...
namespace OpenClaw.Infrastructure.Migrations
{
    ...
    [Migration("20260404141827_AddAgentExecutionTable")]
    partial class AddAgentExecutionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenClaw.Domain.Auth.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OpenClaw.Domain.HierarchicalAgents.Entities.AgentExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("NodeStatesJson")
                        .HasColumnType("text")
                        .HasColumnName("node_states_json");
                    ...
                    b.Property<decimal>("TotalTokensUsed")
                        .HasPrecision(18, 4)
                    ...
                    b.HasIndex("AgentName")
                        .HasDatabaseName("ix_agent_executions_agent_name");

                    b.HasIndex("ParentExecutionId")
                        .HasDatabaseName("ix_agent_executions_parent_id");
