...
public class User : AggregateRoot<Guid>
{
        ...
        UserStatus? status = null)
    {
        ...
        user._permissions.AddRange(permissions ?? [Permission.ClawOS]);
    ...
    public ErrorOr<Success> Ban(string reason, IReadOnlyList<string> targetRoles)
    {
        ...
        BanReason = reason;
        _permissions.Remove(Permission.ClawOS);
        RefreshToken = null;
    ...
    public void Unban()
    {
        ...
        BanReason = null;
        if (!_permissions.Contains(Permission.ClawOS))
            _permissions.Add(Permission.ClawOS);
        UpdatedAt = DateTime.UtcNow;
    }
