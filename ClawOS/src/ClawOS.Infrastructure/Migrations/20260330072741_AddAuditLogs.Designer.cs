...
namespace ClawOS.Infrastructure.Migrations
{
    ...
    [Migration("20260330072741_AddAuditLogs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClawOS.Domain.Audit.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ClawOS.Domain.Chat.Entities.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ClawOS.Domain.Chat.Entities.ConversationMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ClawOS.Domain.Configuration.Entities.AppConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ClawOS.Domain.Configuration.Entities.ChannelSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ClawOS.Domain.Configuration.Entities.ModelProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ClawOS.Domain.Configuration.Entities.UserModelProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ClawOS.Domain.CronJobs.Entities.CronJob", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ClawOS.Domain.CronJobs.Entities.CronJobExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ClawOS.Domain.CronJobs.Entities.ToolInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ClawOS.Domain.Skills.Entities.SkillSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ClawOS.Domain.Users.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ClawOS.Domain.Users.Entities.UserConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ClawOS.Domain.Users.Entities.UserPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ClawOS.Domain.Chat.Entities.ConversationMessage", b =>
                {
                    b.HasOne("ClawOS.Domain.Chat.Entities.Conversation", null)
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("ClawOS.Domain.Configuration.Entities.UserModelProvider", b =>
                {
                    b.HasOne("ClawOS.Domain.Configuration.Entities.ModelProvider", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ClawOS.Domain.CronJobs.Entities.CronJobExecution", b =>
                {
                    b.HasOne("ClawOS.Domain.CronJobs.Entities.CronJob", "CronJob")
                        .WithMany("Executions")
