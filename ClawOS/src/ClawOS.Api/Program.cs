...
using Weda.Protocol;
using ClawOS.Api;
using ClawOS.Application;
using ClawOS.Contracts;
using ClawOS.Infrastructure;
using ClawOS.Infrastructure.Common.Persistence;
using ClawOS.Hosting;
using ClawOS.Hosting.Observability;
using ClawOS.Api.Security;
using ClawOS.Application.CronJobs;
using ClawOS.Api.Audit;
...
var builder = WebApplication.CreateBuilder(args);
{
    ...
    builder.Services
        .AddClawOS(builder.Configuration)
        .AddClawOSTelemetry(builder.Configuration)
        .AddApplication()
        ...
        .AddWedaCore<IAssemblyMarker, IContractsMarker, IApplicationMarker>(
            ...
            options =>
            {
                ...
                {
                    Title = "ClawOS.NET API",
                    Version = "v1",
                };
                options.Observability.ServiceName = "ClawOS.NET";
...
var app = builder.Build();
{
    ...
    var workspaceBasePath = Environment.GetEnvironmentVariable("CLAWOS_WORKSPACE_PATH")
    ...
    app.UseWedaCore<AppDbContext>(options =>
    {
        ...
        options.SwaggerEndpointName = "ClawOS.NET API V1";
