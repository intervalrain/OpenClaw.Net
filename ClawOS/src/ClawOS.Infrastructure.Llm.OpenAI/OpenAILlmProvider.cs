...
using ClawOSChatMessage = ClawOS.Contracts.Llm.ChatMessage;

namespace ClawOS.Infrastructure.Llm.OpenAI;
...
public class OpenAILlmProvider : ILlmProvider
{
    ...
    public async Task<LlmChatResponse> ChatAsync(
        IReadOnlyList<ClawOSChatMessage> messages,
    ...
    private static OpenAIChatMessage ToOpenAIMessage(ClawOSChatMessage msg)
    {
        switch (msg.Role)
        {
