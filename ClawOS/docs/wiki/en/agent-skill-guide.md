...
keywords: ['ClawOS', 'Skill', 'Plugin', 'Development', 'Tutorial']
description: 'Learn how to create custom Skills for ClawOS.NET'
---

# Agent Skill Development Guide

> Learn how to create custom Skills for ClawOS.NET
...
Skills only depend on `ClawOS.Contracts`, making them lightweight and easy to distribute.
...
```bash
dotnet new classlib -n ClawOS.Skills.MySkills
cd ClawOS.Skills.MySkills
dotnet add package ClawOS.Contracts
```
...
namespace ClawOS.Skills.MySkills;
...
See [ClawOS.Skills.FileSystem](../skills/ClawOS.Skills.FileSystem/) for reference implementations:
...
<Project Sdk="Microsoft.NET.Sdk">
  <PropertyGroup>
    ...
    <PackageId>ClawOS.Skills.MySkills</PackageId>
    <Version>1.0.0</Version>
  </PropertyGroup>

  <ItemGroup>
    <PackageReference Include="ClawOS.Contracts" Version="1.0.0" />
  </ItemGroup>
</Project>
```
...
```bash
dotnet add package ClawOS.Skills.MySkills
```
