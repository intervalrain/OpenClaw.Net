...
sidebar_label: '簡介'
hide_title: true
title: 'ClawOS.NET - AI Agent 執行環境'
...
ClawOS.NET 是一個企業級 AI Agent 平台，透過可擴充的 Skill 系統，讓 LLM 驅動的 Agent 能夠執行真實世界的任務。本專案著重於工程品質、型別安全與長期可維護性。
