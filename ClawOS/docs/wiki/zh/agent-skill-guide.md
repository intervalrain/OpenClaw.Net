...
description: '學習如何為 ClawOS.NET 建立自訂 Skill'
---

# Agent Skill 開發指南

> 學習如何為 ClawOS.NET 建立自訂 Skill
...
Skill 僅依賴 `ClawOS.Contracts`，使其輕量且易於發布。
...
參考 [ClawOS.Skills.FileSystem](../skills/ClawOS.Skills.FileSystem/) 的實作範例：
